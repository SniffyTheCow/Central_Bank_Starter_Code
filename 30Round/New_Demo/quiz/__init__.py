...
class Player(BasePlayer):
    ...
    question_5 = models.IntegerField(
        ...
        label="5. You chose to trade, you are red, and only one other person chose to trade. "
              "The majority vote is YES. Your earnings are:",
        choices=[
            [0, "59 points"],
            [0, "159 points"],
            [1, "109 points"],
    ...
    question_6 = models.IntegerField(
        ...
        choices=[
            ...
            [1, "You earn 60 points and half a 1/3 chance to receive the reduced bonus"],
        ]
    )

    question_7 = models.IntegerField(
        widget=widgets.RadioSelect,
        label="7. No one chose to trade and YES is the majority vote. "
              "Here, no one completes a trade and everyone earns",
        choices=[
            [0, "58 points"],
            [1, "60 points"],
    ...
    question_8 = models.IntegerField(
        widget=widgets.RadioSelect,
        label="8. Everyone chose to trade and YES is the majority vote. "
